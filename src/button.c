                                             ...
                                             const SDL_Event event)
{
  if(!button)
  {
    ...
    return (result_bool){
      .ok = false,
      .error = "Cannot process SDL_Event on a button_widget pointing to NULL!"};
  }
                                   ...
                                   void (*animator)(button_widget*))
{
  if(!button)
  {
    ...
    return (result){.ok = false,
                    .error =
                      "Cannot set animator to button_widget pointing to NULL!"};
  }
...
result button_widget__render(button_widget* button)
{
  ...
  /// TODO: Render button
  rocket_render__rectangle_filled(button->x,
                                  button->y,
                                  button->width,
                                  button->height,
                                  button->background_color);
  rocket_render__text(button->x + button->padding_x,
                      button->y + button->padding_y,
                      button->text,
...
result_int button_widget__get_x(button_widget* button)
{
  if(!button)
  {
    ...
    return (result_int){
      .ok = false,
      .error = "Cannot get x-coordinate of a button_widget, pointing to NULL!"};
  }
...
result_int button_widget__get_y(button_widget* button)
{
  if(!button)
  {
    ...
    return (result_int){
      .ok = false,
      .error = "Cannot get y-coordinate of a button_widget, pointing to NULL!"};
  }
...
result button_widget__set_x(button_widget* button, const int x)
{
  if(!button)
  {
    ...
    return (result){
      .ok = false,
      .error = "Cannot set x-coordinate of a button_widget, pointing to NULL!"};
  }
...
result button_widget__set_y(button_widget* button, const int y)
{
  if(!button)
  {
    ...
    return (result){
      .ok = false,
      .error = "Cannot set y-coordinate of a button_widget, pointing to NULL!"};
  }
...
result button_widget__set_text(button_widget* button, const char* text)
{
  if(!button)
  {
    ...
    return (result){.ok = false,
                    .error =
                      "Cannot set text of a button_widget, pointing to NULL!"};
  }
  ...
  if(!text)
  {
    ...
    return (result){
      .ok = false,
      .error = "Cannot set text of button_widget, with text pointing to NULL!"};
  }
